import { AfterViewInit, Component, ElementRef, OnChanges, OnInit, Signal, ViewChild, computed } from '@angular/core';
...
export class DiaryEntryNewFormComponent implements OnInit, OnChanges, AfterViewInit {
